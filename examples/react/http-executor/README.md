# Using GraphQL Code Generator with `graphql-request` and React

This example illustrates how to use GraphQL Code Generator in a React application using the
