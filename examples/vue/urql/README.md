# Using GraphQL Code Generator with URQL and Vue 3

This example illustrates using GraphQL Code Generator in a Vue 3 application using the URQL GraphQL
Client.
...
Please note that the `client` preset used in this example is compatible with `@urql/vue` (since
`1.11.0`).
