...
export type NearOperationFileConfig = {
  /**
   * @description Should point to the base schema types file.
   * The key of the output is used a the base path for this file.
   *
   * If `noExport` is used for the Typescript plugin, this can be omitted, otherwise this is required.
   *
...
export const preset: Types.OutputPreset<NearOperationFileConfig> = {
  buildGeneratesSection: options => {
    ...
    let schemaTypesSource: ImportSource;
    if (baseTypesPath) {
