...
export const plugin: PluginFunction<JavaApolloAndroidPluginConfig> = (schema: GraphQLSchema, documents: Types.DocumentFile[], config: JavaApolloAndroidPluginConfig): Types.PluginOutput => {
