...
export const plugins: Array<PluginOption> = [
  ...
  },
  {
    ...
    available: tags =>
      allOf(tags, Tags.client, Tags.typescript) || hasTag(Tags.stencil)(tags),
    shouldBeSelected: tags =>
      oneOf(tags, Tags.angular, Tags.stencil) ||
      allOf(tags, Tags.typescript, Tags.react),
    defaultExtension: ".ts"
  ...
  {
    name: `TypeScript Resolvers ${italic(
  ...
  {
    name: `TypeScript GraphQL files modules ${italic(
      "(declarations for .graphql files)"
    )}`,
  ...
  {
    name: `TypeScript GraphQL document nodes ${italic(
      "(embedded GraphQL document)"
    )}`,
    package: "@graphql-codegen/typescript-document-nodes",
    value: "typescript-document-nodes",
    pathInRepo: "typescript/document-nodes",
    available: tags =>
      allOf(tags, Tags.typescript) || hasTag(Tags.stencil)(tags),
    shouldBeSelected: () => false,
    defaultExtension: ".ts"
  },
  {
