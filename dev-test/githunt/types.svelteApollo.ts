...
import type { ApolloClient, SubscriptionOptions, QueryOptions, MutationOptions } from '@apollo/client';
...
`;
export const SubscriptionOnCommentAdded = (
  options: Omit<SubscriptionOptions<OnCommentAddedSubscriptionVariables>, 'query'> = {}
) => getClient().subscribe<OnCommentAddedSubscription>({ query: OnCommentAddedDocument, ...options });
...
`;
export const QueryComment = (options: Omit<QueryOptions<CommentQueryVariables>, 'query'> = {}) =>
  getClient().query<CommentQuery>({ query: CommentDocument, ...options });
...
`;
export const QueryCurrentUserForProfile = (options: Omit<QueryOptions<CurrentUserForProfileQueryVariables>, 'query'>) =>
  getClient().query<CurrentUserForProfileQuery>({ query: CurrentUserForProfileDocument, ...options });
...
`;
export const QueryFeed = (options: Omit<QueryOptions<FeedQueryVariables>, 'query'> = {}) =>
...
export const SubmitCommentDocument = gql`
  ...
  ${CommentsPageCommentFragmentDoc}
`;
export const MutationSubmitComment = (
  options: Omit<MutationOptions<SubmitCommentMutation, SubmitCommentMutationVariables>, 'mutation'> = {}
) => getClient().mutate({ mutation: SubmitCommentDocument, ...options });
...
`;
export const MutationVote = (options: Omit<MutationOptions<VoteMutation, VoteMutationVariables>, 'mutation'> = {}) =>
  getClient().mutate({ mutation: VoteDocument, ...options });
