...
export namespace AdminUserResolvers {
  ...
  export type LikedPostsResolver<R = Maybe<Maybe<Post>[]>, Parent = AdminUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext
  >;
  export type FollowerUsersResolver<R = Maybe<Maybe<User>[]>, Parent = AdminUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowerUsersArgs
  ...
  export type FollowingUsersResolver<R = Maybe<Maybe<User>[]>, Parent = AdminUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowingUsersArgs
  ...
  export type PostsResolver<R = Maybe<Maybe<Post>[]>, Parent = AdminUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    PostsArgs
...
export namespace WriterUserResolvers {
  ...
  export type LikedPostsResolver<R = Maybe<Maybe<Post>[]>, Parent = WriterUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    LikedPostsArgs
  ...
  export type FollowerUsersResolver<R = Maybe<Maybe<User>[]>, Parent = WriterUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowerUsersArgs
  ...
  export type FollowingUsersResolver<R = Maybe<Maybe<User>[]>, Parent = WriterUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowingUsersArgs
  ...
  export type PostsResolver<R = Maybe<Maybe<Post>[]>, Parent = WriterUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    PostsArgs
...
export namespace ReaderUserResolvers {
  ...
  export type LikedPostsResolver<R = Maybe<Maybe<Post>[]>, Parent = ReaderUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    LikedPostsArgs
  ...
  export type FollowerUsersResolver<R = Maybe<Maybe<User>[]>, Parent = ReaderUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowerUsersArgs
  ...
  export type FollowingUsersResolver<R = Maybe<Maybe<User>[]>, Parent = ReaderUser, TContext = {}> = Resolver<
    R,
    Parent,
    TContext,
    FollowingUsersArgs
