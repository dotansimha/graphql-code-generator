...
export namespace QueryResolvers {
  ...
  export type ReviewsResolver = Resolver<ReadonlyArray<Review | null> | null, ReviewsArgs>;
  export interface ReviewsArgs {
    episode: Episode;
  }

  export type SearchResolver = Resolver<ReadonlyArray<SearchResult | null> | null, SearchArgs>;
...
export namespace FriendsConnectionResolvers {
  ...
  export type EdgesResolver = Resolver<ReadonlyArray<FriendsEdge | null> | null>;
  export type FriendsResolver = Resolver<ReadonlyArray<Character | null> | null>;
...
export namespace HumanResolvers {
  ...
  export type AppearsInResolver = Resolver<ReadonlyArray<Episode | null>>;
  export type StarshipsResolver = Resolver<ReadonlyArray<Starship | null> | null>;
}
