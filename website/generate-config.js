...
const mapping = {
  ...
  '../packages/plugins/flow/src/index.ts': BASE_DIR + '/flow.md',
  ...
  '../packages/plugins/visitor-plugin-common/src/base-visitor.ts': BASE_DIR + '/base-visitor.md',
  '../packages/plugins/visitor-plugin-common/src/base-types-visitor.ts': BASE_DIR + '/base-types-visitor.md',
  '../packages/plugins/visitor-plugin-common/src/base-resolvers-visitor.ts': BASE_DIR + '/base-resolvers-visitor.md',
  '../packages/plugins/visitor-plugin-common/src/base-documents-visitor.ts': BASE_DIR + '/base-documents-visitor.md',
  '../packages/plugins/visitor-plugin-common/src/client-side-base-visitor.ts': BASE_DIR + '/client-side-base-visitor.md',
};

Object.keys(mapping).forEach(async source => {
