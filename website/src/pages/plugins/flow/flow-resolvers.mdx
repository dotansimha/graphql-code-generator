...
description:
  Flow plugin for GraphQL Code Generator. Generates Flow types for your GraphQL resolvers.
---
...
it refers to `typescript-resolvers` but everything there is relevant to `flow-resolvers` as well.
