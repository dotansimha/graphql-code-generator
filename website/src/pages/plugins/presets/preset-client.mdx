...
- [`useTypeImports`](/plugins/typescript/typescript#usetypeimports): Will use `import type {}`
  ...
  option.
- [`immutableTypes`](/plugins/typescript/typescript#immutabletypes): Generates immutable types by
  adding `readonly` to properties and `ReadonlyArray` for lists.
...
- [`enumsAsConst`](/plugins/typescript/typescript#enumsasconst): Generates enum as TypeScript const
...
- [`enumValues`](/plugins/typescript/typescript#enumvalues): Overrides the default value of enum
...
- [`skipTypeNameForRoot`](/plugins/typescript/typescript-operations#skiptypenameforroot): Avoid
  ...
  `__typename`.
- [`onlyOperationTypes`](/plugins/typescript/typescript#onlyoperationtypes): This will cause the
  generator to emit types required for operations only i.e. only enums and scalars.
- [`onlyEnums`](/plugins/typescript/typescript#onlyenums): This will cause the generator to emit
  types for enums only.
