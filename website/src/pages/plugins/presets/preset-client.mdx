...
```bash
npm i -D @graphql-codegen/client-preset-swc-plugin-optimizer
yarn add -D @graphql-codegen/client-preset-swc-plugin-optimizer
pnpm i -D @graphql-codegen/client-preset-swc-plugin-optimizer
```
