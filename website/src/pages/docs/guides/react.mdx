...
import { PackageCmd } from '../../../components/PackageCmd'
...
<PackageCmd
  packages={[
    {
      name: '@graphql-codegen/typescript-react-query @graphql-codegen/typescript @graphql-codegen/typescript-operations',
      isDev: true
    }
  ]}
/>
...
<PackageCmd
  packages={[
    {
      name: '@graphql-codegen/typed-document-node @graphql-codegen/typescript @graphql-codegen/typescript-operations',
      isDev: true
    }
  ]}
/>
...
<PackageCmd
  packages={[
    {
      name: '@graphql-codegen/typescript-react-apollo @graphql-codegen/typescript @graphql-codegen/typescript-operations',
      isDev: true
    }
  ]}
/>
...
<PackageCmd
  packages={[
    {
      name: '@graphql-codegen/typescript-urql @graphql-codegen/typescript @graphql-codegen/typescript-operations',
      isDev: true
    }
  ]}
/>
