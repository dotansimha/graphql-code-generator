...
## Install the `@graphql-codegen/typescript-operations` plugin

<PackageCmd packages={[{ name: '@graphql-codegen/typescript-operations @graphql-codegen/typescript', isDev: true }]} />
