...
<PackageCmd
  packages={[
    {
      name: 'graphql-codegen-svelte-apollo @graphql-codegen/typescript @graphql-codegen/typescript-operations',
      isDev: true
    }
  ]}
/>
...
<PackageCmd packages={['@kitql/client', { name: '@kitql/graphql-codegen', isDev: true }]} />
