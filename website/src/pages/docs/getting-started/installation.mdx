...
We recommend using [a `client` preset](/docs/plugins/presets/preset-client) that has a recommended configuration for the client applications. You can follow one of the following guides:
