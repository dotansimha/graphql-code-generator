  ...
  return (
    <section className={cn('px-4 py-6 sm:py-12 md:px-6 lg:py-24 xl:px-[120px]', props.className)}>
      ...
      <ul className="mt-6 flex flex-row flex-wrap justify-center gap-2 md:mt-16 md:gap-6">
        ...
        >
          Automate the creation of typed queries, mutations, and subscriptions for frameworks like
        ...
        >
          Generate typed GraphQL resolvers for any Node.js or Java GraphQL server, ensuring
        ...
        >
          Produce fully-typed Node.js SDKs, enhancing development with reliable, strongly typed
          software components.
        </InfoCard>
      </ul>
    </section>
