...
export const EXAMPLES = {
  ...
  types-and-hooks.tsx:
    ...
    },
    {
      ...
      description: `This example uses types generated by \`typescript\` and \`typescript-operations\`, and creates a fully type-safe React Hooks, based on your GraphQL operations, by injecting those into an existing RTK-Query api.`,
