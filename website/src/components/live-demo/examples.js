...
export const EXAMPLES_ICONS = {
  ...
  svelte: k => <img alt={'SvelteJS'} className={classes.exampleIcon} key={k} src={'/img/icons/svelte.svg'} />,
...
export const EXAMPLES = {
  ...
  composition-functions.ts:
    ...
    {
      name: 'Svelte-Apollo composition functions',
      description: `This example uses types generated by \`typescript\` and \`typescript-operations\`, and creates function for using ApolloClient.`,
      tags: ['typescript', 'svelte', 'apollo', 'frontend'],
      config: `generates:
  composition-functions.ts:
    plugins:
      - typescript
