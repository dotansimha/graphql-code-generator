...
You can use this plugin to generate an
[allow list](https://hasura.io/docs/latest/graphql/cloud/security/allow-lists.html) for your
[hasura](https://hasura.io) project.

This can be useful to keep your allow list and front end code in sync.

## Examples

```ts title="codegen.ts" {7}
