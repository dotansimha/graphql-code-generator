---
description: How to specify your GraphQL Schema in GraphQL Code Generator. Learn
  how to load your schema from a remote server, local file, or multiple files.
title: schema field
---
...
```sh
GITHUB_TOKEN=<YOUR GITHUB TOKEN> npm run graphql-codegen
```
...
```json title="package.json" /-r ts-node\/register/
{
  "scripts": {
