...
title: GraphQL Codegen with React Query
...
```typescript title="GraphQL Codegen Configuration"
...
```sh title="Run GraphQL Code Generator"
...
```sh title="Run GraphQL Code Generator in watch mode"
...
```typescript title="src/graphql/execute.ts"
...
```tsx title="Example usage of executing a Query Operation with React Query"
