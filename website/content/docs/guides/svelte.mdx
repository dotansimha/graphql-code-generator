---
description:
  Generate typed code for SvelteKit and Apollo. GraphQL Code Generator and the community provide
  typed code generation for Apollo, SvelteKit _native_, and other clients.
title: 'Guide: Svelte / Kit'
sidebarTitle: Svelte / Kit
---

GraphQL Code Generator and the community provide typed code generation for Apollo, SvelteKit
_native_, and other clients.
...
Thank to the
[community-built plugin](https://github.com/ticruz38/graphql-codegen-svelte-apollo#readme)
...
[plugin documentation](/plugins/typescript-svelte-apollo) and the
[GitHub repository README](https://github.com/ticruz38/graphql-codegen-svelte-apollo).
...
With [KitQL Codegen](https://github.com/jycouet/kitql/tree/main/packages/graphql-codegen), you get
...
[KitQL documentation](https://github.com/jycouet/kitql/tree/main/packages/graphql-codegen).
