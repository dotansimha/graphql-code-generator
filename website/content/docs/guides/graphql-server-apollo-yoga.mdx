---
description: GraphQL Code Generator's `@graphql-codegen/typescript-resolvers`
  plugin generates TypeScript types for your GraphQL API's resolvers.
title: "Guide: GraphQL Yoga / Apollo Server"
sidebarTitle: Apollo Server / GraphQL Yoga
---
