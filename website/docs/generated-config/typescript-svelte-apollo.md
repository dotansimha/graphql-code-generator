This plugin generates functions with TypeScript typings using Svelte context.
...
<img alt="typescript-svelte-apollo plugin version" src="https://img.shields.io/npm/v/@graphql-codegen/typescript-svelte-apollo?color=%23e15799&label=plugin&nbsp;version&style=for-the-badge"/>


    
:::shell Using `yarn`
    yarn add -D @graphql-codegen/typescript-svelte-apollo
:::
