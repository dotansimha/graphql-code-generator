...
Even while using another GraphQL Cient (not listed in our guides) or willing to only use generated TypeScript types, GraphQL Code Generator still got you covered!

`@graphql-codegen/typescript-operations` is the perfect plugin is your prefer only manipulate generated TypeScript types.
