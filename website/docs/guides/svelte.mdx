...
GraphQL Code Generator provides the `graphql-codegen-svelte-apollo` plugin that generates full-typed Apollo GraphQL services.
...
For more advanced configuration (custom fetcher, authentication), please refer to the [plugin documentation](/plugins/typescript-svelte-apollo).
