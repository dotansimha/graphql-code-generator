...
<PackageInstall packages={["@graphql-codegen/typescript-apollo-angular", "@graphql-codegen/typescript", "@graphql-codegen/typescript-operations"]} />
...
For more advanced configuration (custom fetcher, authentication), please refer to the [plugin documentation](/plugins/typescript-apollo-angular).
