...
GraphQL Code Generator is a tool that provides a set of plugins that help you get the best out of your GraphQL stack.
...
The following sections showcase why GraphQL Code Generator is a game-changer in your GraphQL Stack.
...
Now, with a simple configuration and an npm/yarn script, the front-end developers benefit from:
...
For this reason, GraphQL Code Generator provides multiple plugins that help automate the generation of resolvers' typings.
...
<CodeTabs namespace={`getting-started-back-end-codetabs`}>
...
You can go over [the list of available plugins](/plugins) and find more plugins that match your needs.
